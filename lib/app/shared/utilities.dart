...
double wW(double size, context) =>
    MediaQuery.of(context).size.width / 1920 * size;
...
String traduce(String txt) {
  if (traductions.containsKey(txt.toLowerCase())) {
    return traductions[txt.toLowerCase()]!;
  }
  return txt;
}
