...
import 'package:delivery_admin_white_label/app/modules/product/widgets/additional.dart';
import 'package:delivery_admin_white_label/app/modules/product/widgets/characteristics.dart';
import 'package:delivery_admin_white_label/app/modules/product/widgets/store_informations.dart';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DocumentSnapshot> additionalQuery =
