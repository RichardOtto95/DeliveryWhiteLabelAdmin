...
class FullPerformance extends StatefulWidget {
  ...
  const FullPerformance({Key? key, required this.agentId}) : super(key: key);
...
class Earnings extends StatelessWidget {
  ...
  Earnings({Key? key, required this.agentId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        padding:
            EdgeInsets.only(top: viewPaddingTop(context) + wXD(60, context)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            GainFilterDate(),
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                      color: getColors(context).primary.withOpacity(.40)),
                  borderRadius: BorderRadius.all(Radius.circular(3)),
                ...
                child: FutureBuilder<Map>(
                  future: store.getConcludedOrders(agentId),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("Sem dados",
              style: textFamily(context, color: getColors(context).primary)),
          Text(
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(3)),
          color: getColors(context).primary.withOpacity(.7),
          // boxShadow: [
          //   BoxShadow(
          //     blurRadius: 3,
          //     offset: Offset(0, 3),
