      ...
      body: Stack(
        children: [
                            ...
                            .map((categorie) => Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      if (store.categories.last != categorie)
          ...
          DefaultAppBar(
            widget.category,
            onPop: () {
              store.categories.removeAt(store.categories.length - 1);
              Modular.to.pop();
            },
          ),
          AnimatedPositioned(
  ...
  getEditSubCategory() {
    editCategoryOverlay = OverlayEntry(
      builder: (context) => EditCategoryOverlay(
        ...
        onCategories: () {
          editCategoryOverlay.remove();
          store.categories.add(widget.subcategory.label);
