...
import 'package:delivery_admin_white_label/app/core/models/category_model.dart';
import 'package:delivery_admin_white_label/app/modules/categories/categories_store.dart';
import 'package:delivery_admin_white_label/app/modules/categories/widgets/add_category_popup.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ScrollConfiguration(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            crossAxisAlignment: snapshot.data!.docs.length < 4
                                ? CrossAxisAlignment.start
                                : CrossAxisAlignment.center,
                            children: [
                              Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal: wXD(0, context, ws: 20)),
                                child: Wrap(
          ...
          DefaultAppBar("Categorias", main: true),
          AnimatedPositioned(
  ...
  getEditCategory() {
    editCategoryOverlay = OverlayEntry(
      builder: (context) => EditCategoryOverlay(
        ...
        onCategories: () {
          editCategoryOverlay.remove();
          store.categories.add(widget.category.label);
