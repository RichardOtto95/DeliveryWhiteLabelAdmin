...
import 'package:delivery_admin_white_label/app/shared/widgets/cross.dart';
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              width: wXD(171, context, ws: 400, mediaWeb: true),
          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                ...
                //     : null,
                initialValue:
                    'R\$ ${formatedCurrency(store.adEdit.totalPrice)}',
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.only(
                left: wXD(17, context),
                right: wXD(0, context, ws: 25, mediaWeb: true),
              ),
              padding: EdgeInsets.symmetric(horizontal: wXD(12, context)),
              decoration: BoxDecoration(
                color: getColors(context).surface,
              ...
              child: TextFormField(
                ...
                //     ? _formatter.format((store.adEdit.sellerPrice * 10).toString())
                //     : null,
                initialValue: store.adEdit.pdvCode?.toString() ?? "",
                autovalidateMode: AutovalidateMode.onUserInteraction,
      ...
      return Column(
        ...
        children: [
          ...
          Center(
            child: Container(
              height: wXD(52, context),
              width: wXD(342, context, ws: 1494, mediaWeb: true),
              decoration: BoxDecoration(
                color: getColors(context).surface,
                border: Border.all(color: getColors(context).primary),
                borderRadius: BorderRadius.all(Radius.circular(3)),
              ...
              children: [
                        ...
                        return Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Visibility(
                                  visible: store.adEdit.category != "",
                                  child: CategorieSelected(
                                    title: store.adEdit.category,
                                    onRemove: () => store.adEdit.category = "",
                                  ),
                                ),
                                SizedBox(width: wXD(10, context)),
                                Visibility(
                                  visible: store.adEdit.option != "",
                                  child: CategorieSelected(
                                    title: store.adEdit.option,
                                    onRemove: () => store.adEdit.option = "",
                                  ),
                                ),
                                // Text(
                                //   store.editingAd
                                //       ? '${store.adEdit.category}'
                                //       : store.adsCategory == ''
                ...
                Positioned(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () => Modular.to
                          .pushNamed('/advertisement/choose-category'),
                      child: SizedBox(
                        height: wXD(38, context),
                        width: wXD(38, context),
                        child: Icon(
                          Icons.add_rounded,
                          size: wXD(25, context),
                    ...
                    if (!kIsWeb)
                      Container(
                        ...
                        child: Observer(
                          builder: (context) {
                            return Column(
                              children: store.checkedAdditionalList.map(
                                (element) {
                                  return FutureBuilder<DocumentSnapshot>(
                                    ...
                                    builder: (context, snapshotFutureDoc) {
                                      ...
                                      // print("additionalDoc: ${additionalDoc.id}");
                                      if (additionalDoc['seller_config'] !=
                                          "edition") {
                                        return Container();
                                      }
...
class CustomRadio extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    Widget MyRadio(bool active, void Function() onTap) => Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  border:
                      Border.all(color: getColors(context).primary, width: 2),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color:
                      active ? getColors(context).primary : Colors.transparent,
                ),
              ),
            ),
          ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          MyRadio(
            store.adEdit.isNew,
            () => store.adEdit.isNew = !store.adEdit.isNew,
          ),
          Text(
            "Novo",
            style: textFamily(
...
class CategorieSelected extends StatelessWidget {
  final String title;
      ...
      child: FutureBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!store.additionalResponse.containsKey(widget.model.id)) {
              ...
              store.additionalResponse.putIfAbsent(
                  widget.model.id,
                  () => {
                          ...
                          children: [
                            Radio(
                              ...
                              onChanged: (int? value) {
                                ...
                                store.additionalResponse.update(
                                    widget.model.id,
                                    (value) => {
                                          "response_label":
                                              radiobuttonMap['label'],
                                          "response_value":
                                              radiobuttonMap['value'],
                                          "response_index":
                                              radiobuttonMap['index'],
                                        });
                              },
                            ),
                            Expanded(
        ...
        FutureBuilder<dynamic>(
            ...
            builder: (context, snapshot) {
              ...
              return Container(
                ...
                // alignment: Alignment.centerLeft,
                child: Container(
                  width: widget.model.short == false
                      ? maxWidth(context) / 2
                      : maxWidth(context),
                  ...
                  child: TextFormField(
                    ...
                    validator: (String? value) {
                      if (value == null ||
                          value == "" && widget.model.mandatory == true) {
                    ...
                    onChanged: (String value) {
                      if (!store.additionalResponse
                          .containsKey(widget.model.id)) {
                        store.additionalResponse.putIfAbsent(
                            widget.model.id,
                            () => {
                                  "response_text": value,
                          ...
                          if (count > widget.model.incrementMinimum!) {
                            ...
                            store.additionalResponse.update(
                                ...
                                (value) => {
                                      ...
                                      "response_value":
                                          widget.model.incrementValue! * count,
                                    });
                          }
                        },
                        child: Icon(
          ...
          builder: (context, snapshot) {
            ...
            for (var i = 0; i < checkboxArray.length; i++) {
              ...
              checkedMap.putIfAbsent(
                  checkboxMap['id'], () => checkboxMap['response']);
            }
            store.additionalResponse
                .putIfAbsent(widget.model.id, () => checkedMap);
            return StatefulBuilder(builder: (context, refresh) {
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                        ...
                        return Row(
                          children: [
                            Checkbox(
                              ...
                              onChanged: (bool? value) {
                                refresh(() {
                                  ...
                                  checkedMap.update(
                                      checkboxMap['id'], (val) => !val);
                                  store.additionalResponse.update(
                                      widget.model.id, (value) => checkedMap);
                                  print('checkedMap: $checkedMap');
                                });
                              },
                            ),
                            ...
                            Container(
                              width: wXD(100, context),
                              child: Text(
                                  "R\$ ${formatedCurrency(checkboxMap['value'])}"),
                              alignment: Alignment.centerLeft,
                            ),
                          ],
                        );
        ...
        children: [
          ...
          FutureBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                print(
                    'store.additionalResponse.containsKey(model.id): ${store.additionalResponse.containsKey(widget.model.id)}');
                ...
                return DropdownButton<String>(
                  ...
                  items: dropdownArray.map<DropdownMenuItem<String>>(
