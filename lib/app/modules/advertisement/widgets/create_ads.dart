...
import 'package:delivery_admin_white_label/app/shared/widgets/side_button.dart';
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: wXD(42, context, ws: 80)),
                              // AdsAdditionals(),
...
class AdsAdditionals extends StatefulWidget {
  const AdsAdditionals({Key? key}) : super(key: key);

  @override
  State<AdsAdditionals> createState() => _AdsAdditionalsState();
}

class _AdsAdditionalsState extends State<AdsAdditionals> {
  final AdvertisementStore store = Modular.get();
            ...
            return ReorderableListView(
              ...
              onReorder: (int oldIndex, int newIndex) {
                ...
                setState(() {
                  ...
                  final String item =
                      store.checkedAdditionalList.removeAt(oldIndex);
                  store.checkedAdditionalList.insert(newIndex, item);
                });
              },
            );
          }),
