            ...
            child: FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<QueryDocumentSnapshot<Map<String, dynamic>>>
                      additionalQuery = snapshot.data!.docs;
                    ...
                    children: [
                      ...
                      ...additionalQuery.map((additionalDoc) {
                        return InkWell(
                          ...
                          onTap: () async {
                            if (!additionalDoc['not_edit']) {
                              // print('store.checkedAdditional: ${store.checkedAdditionalMap}');
                              print(
                                  'store.checkedAdditionalList: ${store.checkedAdditionalList}');
                              print('additionalDoc.id: ${additionalDoc.id}');
                              setState(() {
                                if (!store.checkedAdditionalList
                                    .contains(additionalDoc.id)) {
                                  store.checkedAdditionalList
                                      .add(additionalDoc.id);
                                } else {
                                  store.checkedAdditionalList
                                      .remove(additionalDoc.id);
                                }
                              });
                              // print('store.checkedAdditional: ${store.checkedAdditionalMap}');
                              print(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Checkbox(
                                  ...
                                  value: store.checkedAdditionalList
                                      .contains(additionalDoc.id),
                                  onChanged: (bool? value) {
                                    if (!additionalDoc['not_edit']) {
                                      ...
                                      print(
                                          'store.checkedAdditionalList: ${store.checkedAdditionalList}');
                                      print(
                                          'additionalDoc.id: ${additionalDoc.id}');
                                      setState(() {
                                        if (!store.checkedAdditionalList
                                            .contains(additionalDoc.id)) {
                                          store.checkedAdditionalList
