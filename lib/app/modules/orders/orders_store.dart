...
import 'package:delivery_admin_white_label/app/core/models/customer_model.dart';
import 'package:delivery_admin_white_label/app/core/models/directions_model.dart';
import 'package:delivery_admin_white_label/app/core/models/order_model.dart';
import 'package:delivery_admin_white_label/app/core/models/seller_model.dart';
import 'package:delivery_admin_white_label/app/core/models/time_model.dart';
import 'package:delivery_admin_white_label/app/core/services/directions/directions_repository.dart';
...
abstract class _OrdersStoreBase with Store {
  ...
  Future changeOrderStatus(Order model, String status, String token, context,
    ...
    try {
      callableResult = await callable.call(object);
      response = callableResult.data;
