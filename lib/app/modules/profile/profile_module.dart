import 'package:delivery_admin_white_label/app/modules/profile/profile_Page.dart';
import 'package:delivery_admin_white_label/app/modules/profile/profile_store.dart';
import 'package:delivery_admin_white_label/app/modules/profile/widget/answer_rating.dart';
import 'package:delivery_admin_white_label/app/modules/profile/widget/edit_profile.dart';
import 'package:delivery_admin_white_label/app/modules/profile/widget/new_period.dart';
import 'package:delivery_admin_white_label/app/modules/profile/widget/support_chat.dart';
import 'package:delivery_admin_white_label/app/modules/settings/settings_page.dart';
import 'package:delivery_admin_white_label/app/modules/settings/widgets/app_info.dart';
...
class ProfileModule extends WidgetModule {
  ...
  final List<ModularRoute> routes = [
    ...
    ChildRoute('/edit-additional',
        child: (_, args) => EditAdditional(
              model: args.data,
            )),
