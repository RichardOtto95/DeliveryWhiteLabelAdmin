...
import 'package:delivery_admin_white_label/app/core/models/additional_model.dart';
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Radio(
                                              value: "reading",
                                              groupValue: store.editAdditional[
                                                  'seller_config'],
                                              onChanged: (dynamic value) {
                                                if (!widget.model.notEdit) {
                                                  setState(() {
                                                    store.editAdditional[
                                                            'customer_config'] =
                                                        "edition";
                                                    store.editAdditional[
                                                            'seller_config'] =
              ...
              return Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Observer(builder: (context) {
                      if (store.editAdditional['title'] == "" ||
                          store.editAdditional['title'] == null) {
                        return Container();
                      }
                      return Text(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                initialValue:
                                    'R\$ ${formatedCurrency(store.checkboxArray[i]["value"])}',
                                decoration: InputDecoration(
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: store.getColumnAlignment(
            editAlignment: store.editAdditional['alignment']),
        children: [
          Observer(builder: (context) {
            if (store.editAdditional['title'] == null ||
                store.editAdditional['title'] == "") {
              return Container();
            }
            return Text(
              // store.editAdditional['title'],
              store.editAdditional['mandatory'] == true
                  ? store.editAdditional['title'] + "*"
                  : store.editAdditional['title'],
              style: textFamily(
                context,
          ...
          Container(
            width: store.editAdditional['short'] == true
                ? maxWidth(context) / 2
                : maxWidth(context),
...
class IncrementField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (store.editAdditional['increment_minimum'] > store.count) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          if (store.count >
                              store.editAdditional['increment_maximum']) {
                            refresh(() {
                              store.count--;
                            });
                          }
                ...
                Observer(builder: (context) {
                  if (store.editAdditional['increment_value'] == 0) {
                    return Container();
                  }
                  return Container(
...
class RadioButtonArray extends StatelessWidget {
  ...
  RadioButtonArray({Key? key, required this.model, required this.enabled})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
                          ...
                          children: [
                            ...
                            Flexible(
                              child: TextFormField(
                                ...
                                autovalidateMode:
                                    AutovalidateMode.onUserInteraction,
                                initialValue: store.radiobuttonArray[i]
                                    ["label"],
                                decoration:
                                    InputDecoration(hintText: "Opção ${i + 1}"),
                                validator: (txt) {
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                enabled: enabled,
                                initialValue:
                                    'R\$ ${formatedCurrency(store.radiobuttonArray[i]["value"])}',
                                inputFormatters: [_formatter],
                                keyboardType: TextInputType.number,
                                decoration: InputDecoration(
                                  hintText: 'R\$ ${formatedCurrency(0)}',
...
class TextFieldConfig extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    bool mandatory = store.editAdditional['mandatory'] != null
        ? store.editAdditional['mandatory']
        : false;
    bool short = store.editAdditional['short'] != null
        ? store.editAdditional['short']
        : false;
    return Column(
      children: [
        Row(
...
class TextAreaConfig extends StatelessWidget {
  ...
  TextAreaConfig({Key? key, required this.refresh, required this.enabled})
      : super(key: key);
            ...
            Checkbox(
              ...
              onChanged: (value) {
                if (enabled) {
                  store.editAdditional['mandatory'] = value!;
                  print(
                      'store.editAdditional[mandatory]: ${store.editAdditional['mandatory']}');
                  refresh();
                }
              },
            ),
...
class IncrementConfig extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    num minimum = store.editAdditional['increment_minimum'] != null
        ? store.editAdditional['increment_minimum']
        : 1;
    num maximum = store.editAdditional['increment_maximum'] != null
        ? store.editAdditional['increment_maximum']
        : 10;
    num price = store.editAdditional['increment_value'] != null
        ? store.editAdditional['increment_value']
        : 0;
        ...
        Row(
          ...
          children: [
            ...
            Flexible(
              child: TextFormField(
                enabled: enabled,
                initialValue: store.editAdditional['increment_maximum'] != null
                    ? store.editAdditional['increment_maximum'].toString()
                    : null,
                keyboardType: TextInputType.number,
                onChanged: (val) {
                  if (val != "") {
                    ...
                    print(
                        'store.editAdditional[increment_maximum]: ${store.editAdditional['increment_maximum']}');
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            initialValue:
                store.editAdditional['number_mandatory_fields'] != null
                    ? store.editAdditional['number_mandatory_fields'].toString()
                    : null,
            autovalidateMode: AutovalidateMode.onUserInteraction,
            keyboardType: TextInputType.number,
            decoration: InputDecoration(hintText: "0"),
            onChanged: (value) {
              store.editAdditional['number_mandatory_fields'] =
                  num.parse(value);
            },
          ),
        ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                keyboardType: TextInputType.number,
                                initialValue:
                                    'R\$ ${formatedCurrency(store.dropdownArray[i]["value"])}',
                                decoration: InputDecoration(
                                  hintText: 'R\$ ${formatedCurrency(0)}',
                                ),
                                onChanged: (val) {
